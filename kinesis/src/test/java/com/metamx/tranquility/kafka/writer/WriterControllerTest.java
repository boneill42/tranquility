...
public class WriterControllerTest
{
  class TestableWriterController extends WriterController
  {
    ...
    public TestableWriterController(Map<String, DataSourceConfig<PropertiesBasedKinesisConfig>> dataSourceConfigs)
    {
  ...
  public void setUp() throws IOException
  {
    ...
    Map<String, DataSourceConfig<PropertiesBasedKinesisConfig>> datasourceConfigs = ImmutableMap.of(
        "twitter",
        new DataSourceConfig<>(
            "twitter",
            new ConfigurationObjectFactory(propsTwitter).build(PropertiesBasedKinesisConfig.class),
            KafkaConsumerTest.fireDepartmentToScalaMap(fdTwitter)
        ),
        "test[0-9]",
        new DataSourceConfig<>(
            "test[0-9]",
            new ConfigurationObjectFactory(propsTest).build(PropertiesBasedKinesisConfig.class),
